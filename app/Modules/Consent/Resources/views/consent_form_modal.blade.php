...
<div id="consentModal" class="modal" data-next-app-no="{{ $nextAppNo }}" data-store-url="{{ route('consent.store') }}" data-update-base-url="{{ url('/consent') }}">
    <div class="modal-content modal-lg">
        <form method="POST" action="{{ route('consent.store') }}" class="consent-form-wrapper" id="consentForm" autocomplete="off" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body scrollable">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group col-9" id="nameGroup">
                        ...
                        <input type="text" id="name" name="name" placeholder="ชื่อ และ นามสกุลภาษาไทย">
                    </div>
                    ...
                    <div class="form-group col-12">
                        <label for="residence_status">สถานะของการอยู่อาศัย</label>
                    ...
                    <div class="form-group col-12">
                        <label for="documentDelivery">ช่องทางการรับเอกสาร</label>
                    ...
                    <div class="form-group col-6 address-search-field">
                        <label for="documentAddressPostal">ที่อยู่ตามเอกสารสำคัญรหัสไปรษณีย์</label>
                    ...
                    <div class="form-group col-6">
                        <label for="careerField">สาขาอาชีพ</label>
                        <select id="careerField" name="careerField">
                    ...
                    <div class="form-group col-3">
                        <label for="workYears">อายุงานรวม </label>
                        <input type="number" id="workYears" name="workYears" placeholder="ปี" min="0">
                    </div>

                    <div class="form-group col-3">
                        <label for="workMonths">อายุงานรวม</label>
                    ...
                    <div class="form-group col-6" id="extraIncomeSourceWrapper">
                        <label for="extraIncomeSource">แหล่งที่มาของรายได้</label>
                        <select id="extraIncomeSource" name="extraIncomeSource">
                    ...
                    <div id="section4_container" class="section4-container">
                        <div class="form-group col-12">
                            <label>การชี้แจงการมีสินเชื่อบุคคล</label>
                    ...
                    <div class="form-group col-12">
                        <label for="paymentMethod">วิธีการชําระเงิน</label>
