...
return new class extends Migration
{
    ...
    {
        Schema::create('consent_document_deliveries', function (Blueprint $table) {
            ...
            $table->string('document_delivery', 50)->nullable()->comment('รูปแบบการรับเอกสาร');
            $table->string('document_email', 100)->nullable()->comment('อีเมลสำหรับรับเอกสาร');
    ...
    {
        Schema::dropIfExists('consent_document_deliveries');
    }
};
